# Generated by Django 5.0.2 on 2024-04-04 17:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forca_orgao_descricao', models.CharField(max_length=200, null=True, verbose_name='Força/Orgão Externo Descrição')),
                ('create_at', models.DateTimeField(auto_now_add=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('texto', models.CharField(max_length=250, null=True, verbose_name='Texto')),
                ('create_at', models.DateTimeField(auto_now_add=True, null=True)),
            ],
            options={
                'verbose_name': 'Texto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('fk_forca_orgao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_cert.forca_orgao', verbose_name='Força/Orgão Externo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('imagem_tipo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_cert.imagemtipo', verbose_name='Imagem Tipo')),
            ],
            options={
                'verbose_name': 'Imagem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('om', models.CharField(blank=True, max_length=50, null=True, verbose_name='OM')),
                ('om_descricao', models.CharField(blank=True, max_length=200, null=True, verbose_name='OM Descrição')),
                ('create_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('fk_forca_orgao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_cert.forca_orgao', verbose_name='Força/Orgão Externo')),
            ],
            options={
                'verbose_name': 'Força/Orgão',
                'verbose_name_plural': 'Forças/Orgãos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('create_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('fk_texto_modelo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fk_texto_modelo', to='app_cert.textos', verbose_name='Texto Tipo')),
                ('fk_texto_modelo_desc', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fk_texto_modelo_desc', to='app_cert.textos', verbose_name='Texto primeira parte')),
                ('fk_texto_motivo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fk_texto_motivo', to='app_cert.textos', verbose_name='Texto Motivo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('fk_ano_curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_cert.ano', verbose_name='Ano do Curso')),
                ('fk_assinaturas_ch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fk_imagem_ch', to='app_cert.imagem', verbose_name='Assinaturas CH')),
                ('fk_assinaturas_dpl', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fk_imagem_dpl', to='app_cert.imagem', verbose_name='Chefe de divisão')),
                ('fk_curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_cert.curso', verbose_name='Curso')),
                ('fk_img_frente', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fk_img_frente', to='app_cert.imagem', verbose_name='Frente')),
                ('fk_img_fundo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fk_img_fundo', to='app_cert.imagem', verbose_name='Fundo')),
                ('fk_modelo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_cert.modelo', verbose_name='Modelo: Certificado/Honra/Participação')),
                ('fk_tipo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_cert.tipo', verbose_name='Tipo: EAD - Presencial')),
            ],
            options={
                'verbose_name': 'Turma',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_instrucao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_cert.instrucao', verbose_name='Instrução')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aluno_email', models.CharField(blank=True, max_length=50, null=True, verbose_name='Email do Aluno')),
                ...
                ('fk_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='app_cert.status', verbose_name='Situação')),
