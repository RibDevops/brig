...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('turma', models.CharField(max_length=50, verbose_name='Descrição da turma ex: Curso Básico ... - 2023')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('tempo_instrucao', models.IntegerField(verbose_name='Tempo da Instrução')),
                ('fk_in_ex', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_cert.in_ex', verbose_name='FK Tipo Interno Externo')),
                ('fk_instrucao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_cert.instrucao', verbose_name='FK Instrução')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_curso', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='app_cert.curso', verbose_name='FK Curso')),
