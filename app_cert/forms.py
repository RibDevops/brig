...
class AlunoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'fk_status': forms.Select(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'fk_turma': forms.Select(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'fk_curso': forms.Select(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'fk_forca_orgao': forms.Select(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'fk_om': forms.Select(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'fk_posto': forms.Select(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'fk_quadro': forms.Select(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'fk_especialidade': forms.Select(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'fk_aluno_tipo': forms.Select(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'fk_in_ex': forms.Select(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'fk_tratamento': forms.Select(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'aluno_nome': forms.TextInput(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'aluno_cpf': forms.TextInput(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'aluno_email': forms.EmailInput(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'aluno_nota': forms.NumberInput(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'codigo_hash': forms.TextInput(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
            'qrcode': forms.TextInput(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
